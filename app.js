...
var useranswer = prompt('I went to a private school in Hawaii, can you guess which one?');
  ...
  alert('Yes, that\'s the right answer!');
  console.log('Yes, that\'s the right answer!');
  }
  else {
...
var answer2 = prompt('Memorable jobs for me were at Holland America Line, Hyatt Regency Waikiki. Can you guess my Major? ');
  if (useranswer = 'Travel'){
    alert('Good guess!  Actually, I got my B.S.B.A. degree with a Travel Industry Management Major.');
    console.log('Good guess!  Actually, I got my B.S.B.A. degree with a Travel Industry Management Major.');
}
  else {
...
var answer3 = prompt('Do you know which forms of exercise I like?').toLowerCase();
  if (hello === 'Y' || hello === 'yes') {
  alert('That\'s fantastic!');
  console.log('That\'s fantastic!');
}
...
var answer4 = prompt('Do you think I have pet?').toLowerCase();
